...
TypesSelect.onchange = function(){
    console.log(selectedOption(TypesSelect));
    ConstrSelect.options.length = 0;
            printSubArray(TypesItems,selectedOption(TypesSelect));
            
};
ConstrSelect.onchange = changeContr;
